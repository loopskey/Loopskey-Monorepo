...
const seedProfessionalProfile = async (
  ...
  const data = {
    ...
    learningTimeCommitment: P.LearningTimeCommitment.THREE_TO_FIVE_HOURS,
    learningBudgetPreference: P.LearningBudgetPreference.UNDER_100,
  ...
  for (const plan of plans) {
    ...
    const created = await prisma.cPDPlan.create({
      data: {
        ...
        timeAvailable: P.LearningTimeCommitment.THREE_TO_FIVE_HOURS,
