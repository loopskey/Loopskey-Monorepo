export enum AssociationGqlObjectNames {
  ...
  ASSOCIATION_SETTINGS_IMPACT = "AssociationSettingsImpact",
  ASSOCIATION_COMPLIANCE_SETTINGS_PAYLOAD = "AssociationComplianceSettingsPayload",
  ...
  ASSOCIATION_MEMBER_EMAIL_LOOKUP = "AssociationMemberEmailLookup",
  ...
  ASSOCIATION_RECENT_ACTIVITY = "AssociationRecentActivity",
  ...
  ASSOCIATION_REQUIREMENT_PROGRESS_ROW = "AssociationRequirementProgressRow",
...
export enum AssociationGqlQueryNames {
  ...
  MEMBER_EMAIL_LOOKUP = "associationMemberEmailLookup",
  ...
  RECENT_ACTIVITY = "associationRecentActivity",
  ...
  REQUIREMENT_PROGRESS_REPORT = "associationRequirementProgressReport",
...
export enum AssociationGqlMutationNames {
  ...
  UPDATE_COMPLIANCE_SETTINGS = "updateAssociationComplianceSettings",
  UPDATE_NOTIFICATION_SETTINGS = "updateAssociationNotificationSettings",
