...
export const MODULE_OWNERSHIP = {
  ...
  ingestion: BOUNDED_CONTEXTS.LEARNING_CATALOG,
  ...
  support: BOUNDED_CONTEXTS.PUBLIC_SUPPORT,
...
export const SOURCE_PATH_OWNERSHIP = {
  ...
  "src/infrastructure": BOUNDED_CONTEXTS.PLATFORM_SHARED,
} as const;
...
export const MODEL_OWNERSHIP = {
  ...
  IngestionItem: BOUNDED_CONTEXTS.LEARNING_CATALOG,
  IngestionBatch: BOUNDED_CONTEXTS.LEARNING_CATALOG,
  IngestionApiKey: BOUNDED_CONTEXTS.LEARNING_CATALOG,
  IngestionSource: BOUNDED_CONTEXTS.LEARNING_CATALOG,
  ...
  ProfessionalAssociationRequirementLink:
    BOUNDED_CONTEXTS.PROFESSIONAL_DEVELOPMENT,
  ...
  AssociationRequirement: BOUNDED_CONTEXTS.ASSOCIATION_MANAGEMENT,
  ...
  AssociationLearningContentTarget: BOUNDED_CONTEXTS.ASSOCIATION_MANAGEMENT,
  AssociationGeneratedReport: BOUNDED_CONTEXTS.ASSOCIATION_MANAGEMENT,
  AssociationMessageDelivery: BOUNDED_CONTEXTS.ASSOCIATION_MANAGEMENT,
  ...
  OutboxEvent: BOUNDED_CONTEXTS.PLATFORM_SHARED,
  OutboxDelivery: BOUNDED_CONTEXTS.PLATFORM_SHARED,
} as const;
...
export const DOMAIN_DEPENDENCIES = {
  ...
  "public-support": ["communications", "platform-shared"],
  "platform-shared": [],
...
export const MODEL_FREE_CONTEXTS = [
  ...
  BOUNDED_CONTEXTS.PUBLIC_SUPPORT,
  BOUNDED_CONTEXTS.PLATFORM_ADMINISTRATION,
] as const;
