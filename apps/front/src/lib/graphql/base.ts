...
export type AssociationLearningContent = {
  ...
  externalContentType?: Maybe<AssociationLearningExternalType>;
...
export enum AssociationLearningExternalType {
  Article = 'ARTICLE',
  Course = 'COURSE',
  Event = 'EVENT',
  Other = 'OTHER',
...
export type CreateAssociationLearningContentInput = {
  ...
  contentType?: InputMaybe<ContentType>;
  description?: InputMaybe<Scalars['String']['input']>;
  externalContentType?: InputMaybe<AssociationLearningExternalType>;
...
export type CreateIngestionSource = {
  autoPublish?: Scalars['Boolean']['input'];
  fieldMap?: InputMaybe<Scalars['JSONObject']['input']>;
  kind: IngestionContentKind;
  name: Scalars['String']['input'];
  slug: Scalars['String']['input'];
  stalenessWindowDays?: InputMaybe<Scalars['Int']['input']>;
};
...
export type IngestionApiKey = {
  __typename?: 'IngestionApiKey';
  createdAt: Scalars['DateTime']['output'];
  expiresAt?: Maybe<Scalars['DateTime']['output']>;
  id: Scalars['ID']['output'];
...
export type IngestionBatchDetail = {
  __typename?: 'IngestionBatchDetail';
  acceptedCount: Scalars['Int']['output'];
  correlationId?: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['DateTime']['output'];
  createdCount: Scalars['Int']['output'];
  id: Scalars['ID']['output'];
  idempotencyKey: Scalars['String']['output'];
  items: Array<IngestionItemReport>;
  mode: IngestionBatchMode;
  receivedCount: Scalars['Int']['output'];
  rejectedCount: Scalars['Int']['output'];
  sourceId: Scalars['String']['output'];
...
export enum IngestionBatchMode {
  Full = 'FULL',
...
export enum IngestionContentKind {
  Course = 'COURSE',
  Event = 'EVENT',
  Podcast = 'PODCAST',
  Youtube = 'YOUTUBE'
...
export type IngestionItem = {
  ...
  catalog?: Maybe<IngestionItemCatalog>;
  catalogId?: Maybe<Scalars['String']['output']>;
  externalId: Scalars['String']['output'];
  firstSeenAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
  imageCandidateUrl?: Maybe<Scalars['String']['output']>;
  ...
  unmappedFields: Array<Scalars['String']['output']>;
};

export type IngestionItemCatalog = {
  __typename?: 'IngestionItemCatalog';
  id: Scalars['ID']['output'];
  imageUrl?: Maybe<Scalars['String']['output']>;
  slug?: Maybe<Scalars['String']['output']>;
  status: CourseStatus;
...
export type IngestionItemFilter = {
  search?: InputMaybe<Scalars['String']['input']>;
  sourceId?: InputMaybe<Scalars['String']['input']>;
  state?: InputMaybe<IngestionItemState>;
};

export type IngestionItemReport = {
  __typename?: 'IngestionItemReport';
...
export enum IngestionItemState {
  Accepted = 'ACCEPTED',
  Pending = 'PENDING',
  Rejected = 'REJECTED',
  Stale = 'STALE'
...
export type IngestionPageInfo = {
  __typename?: 'IngestionPageInfo';
  hasNextPage: Scalars['Boolean']['output'];
  nextCursor?: Maybe<Scalars['String']['output']>;
};

export type IngestionPagination = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  take?: InputMaybe<Scalars['Int']['input']>;
};
...
export type IngestionSource = {
  ...
  createdAt: Scalars['DateTime']['output'];
  fieldMap: Scalars['JSONObject']['output'];
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
  kind: IngestionContentKind;
  name: Scalars['String']['output'];
  slug: Scalars['String']['output'];
  stalenessWindowDays?: Maybe<Scalars['Int']['output']>;
  updatedAt: Scalars['DateTime']['output'];
};

export type IngestionSourceFilter = {
  isActive?: InputMaybe<Scalars['Boolean']['input']>;
  kind?: InputMaybe<IngestionContentKind>;
  search?: InputMaybe<Scalars['String']['input']>;
};
...
export type IssuedIngestionApiKey = {
  __typename?: 'IssuedIngestionApiKey';
  createdAt: Scalars['DateTime']['output'];
...
export type Mutation = {
  ...
  createEvent: Event;
  createIngestionSource: IngestionSource;
  ...
  rejectIngestionItem: IngestionItem;
  ...
  updateEvent: Event;
  updateIngestionSource: IngestionSource;
  updateMe: User;
...
export type MutationActivateIngestionSourceArgs = {
  sourceId: Scalars['String']['input'];
};
...
export type MutationIssueIngestionApiKeyArgs = {
  input: IssueIngestionApiKey;
};
...
export type MutationRejectIngestionItemArgs = {
  input: RejectIngestionItem;
};
...
export type MutationRevokeIngestionApiKeyArgs = {
...
export type PaginatedIngestionBatches = {
  __typename?: 'PaginatedIngestionBatches';
  items: Array<IngestionBatch>;
  pageInfo: IngestionPageInfo;
  totalCount: Scalars['Int']['output'];
};

export type PaginatedIngestionItems = {
  __typename?: 'PaginatedIngestionItems';
  items: Array<IngestionItem>;
  pageInfo: IngestionPageInfo;
  totalCount: Scalars['Int']['output'];
};

export type PaginatedIngestionSources = {
  __typename?: 'PaginatedIngestionSources';
  items: Array<IngestionSource>;
  pageInfo: IngestionPageInfo;
  totalCount: Scalars['Int']['output'];
};
...
export type Query = {
  ...
  ingestionApiKeys: Array<IngestionApiKey>;
  ingestionBatch: IngestionBatchDetail;
  ingestionBatches: PaginatedIngestionBatches;
...
export type QueryIngestionApiKeysArgs = {
  sourceId: Scalars['String']['input'];
};


export type QueryIngestionBatchArgs = {
  batchId: Scalars['String']['input'];
};


export type QueryIngestionBatchesArgs = {
  pagination?: InputMaybe<IngestionPagination>;
  sourceId: Scalars['String']['input'];
};


export type QueryIngestionItemsArgs = {
  filter?: InputMaybe<IngestionItemFilter>;
  pagination?: InputMaybe<IngestionPagination>;
};
...
export type RejectIngestionItem = {
  itemId: Scalars['String']['input'];
  reason: Scalars['String']['input'];
};
...
export type UpdateIngestionSource = {
