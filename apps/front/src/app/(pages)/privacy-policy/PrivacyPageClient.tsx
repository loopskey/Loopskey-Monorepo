...
const PrivacyPage = () => {
  const { t, sections, activeSectionId, setActiveSectionId } = usePrivacyPage();

  return (
    <main className="overflow-hidden">
      <StaticInfoPage pageKey="privacy" embedded />
      ...
      <section className="px-4 pb-24">
        <div className="mx-auto grid max-w-7xl gap-8 xl:grid-cols-[330px_1fr]">
          <RevealOnScroll direction="left">
            <aside className="space-y-5 xl:sticky xl:top-28">
              <GlassCard className="p-5">
                <div className="mb-5">
                  <p className="text-sm font-semibold text-foreground">
                    {t("privacyPage.nav.title")}
                  </p>

                  <p className="mt-1 text-xs text-muted-foreground">
                    {t("privacyPage.nav.description")}
                  </p>
                </div>
              ...
              <GlassCard className="p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">
                      {t("privacyPage.contactCard.title")}
                    </p>
                    <p className="mt-2 text-sm leading-6 text-muted-foreground">
                      {t("privacyPage.contactCard.description")}
                    </p>
                  </div>
                </div>
                ...
                >
                  <Link href="mailto:privacy@loopskey.com">
                    {t("privacyPage.contactCard.button")}
          ...
          <RevealOnScroll direction="right" delay={120}>
            <div className="space-y-5">
              {sections.map((section, index) => {
                const InfoIcon = section.infoCard
                  ? infoCardIconMap[section.infoCard.icon]
                  : null;
                return (
                  <RevealOnScroll
                    key={section.id}
