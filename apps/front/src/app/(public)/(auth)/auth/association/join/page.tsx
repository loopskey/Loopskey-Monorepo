...
import MemberInvitationJoinCard from "@modules/Auth/MemberInvitationJoinCard";
...
const AssociationJoinPage = () => {
  return (
    <AuthPageShell>
      ...
      >
        <MemberInvitationJoinCard />
      </Suspense>
    </AuthPageShell>
  );
};

export default AssociationJoinPage;
