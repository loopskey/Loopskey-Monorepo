...
import { TGalaxyProps } from "@/types/element.types";
...
export const Galaxy = ({
  ...
  useEffect(() => {
    ...
    // A background layer is `pointer-events-none`, so it never receives its own
    // mouse events; those instances listen on the window instead.
    const eventTarget: HTMLElement | Window =
      mouseTarget === "window" ? window : ctn;
