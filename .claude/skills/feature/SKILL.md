...
- backend: read `apps/api/CLAUDE.md`;
- shared/root: read both app files only when both are affected.
...
6. Finish with the scope gate:
   ...
   - backend: API lint, types, tests, build; E2E/Prisma/codegen when relevant;
